...
public class HawkConfig {
    ...
    public static final String DOH_URL = "doh_url"; // 默认值为1（阿里DNS）
    /**
    ...
    public static final String RESTART_THRESHOLD_HOURS = "restart_threshold_hours";
    public static final String SHOW_RESTART_TOAST = "show_restart_toast";
    public static final String CLEANUP_ON_RESTART = "cleanup_on_restart";
}